...
![Title/short description](./_images/servicenow/image01.png)

#### Request type

Select the type of request from the drop-down. The form includes a table with descriptions/examples of each request type. These request types are generally scoped to the services that SCMS provides. See [SCMS Metadata Services](../README.md) for more information.
...
![Request origin](./_images/servicenow/image03.png)

#### Long description

Describe your request in as much detail as possible.

![Long description](./_images/servicenow/image04.png)

#### Attachments

Attach any relevant files, e.g. project plans/proposals, spreadsheets.

![Manage attachments](./_images/servicenow/image05.png)
...
![Desired completion date](./_images/servicenow/image06.png)
...
![Estimated priority](./_images/servicenow/image07.png)
...
![Estimated effort](./_images/servicenow/image08.png)

#### Contact name

Enter your netID in this field and your name will populate.

![Contact name](./_images/servicenow/image09.png)

#### Submit request

Click the 'Order Now' button to submit your request

![Submit request](./_images/servicenow/image10.png)
...
![My Items](./_images/servicenow/image11.png)
